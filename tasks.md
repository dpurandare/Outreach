...
### Priority 1: Data Infrastructure (Morning)
- Get Apollo.io API access or coordinate with Neha for demo
- Test enrichment workflow with test CSV
- Understand Zoho CRM API capabilities

### Priority 2: Requirements Capture (Afternoon)
- Document Vinod's qualification scoring logic
- Map data fields needed vs. available from Apollo/Sales Nav
- Identify gaps in data for qualification
...
- [ ] Contact Neha Sharma to schedule Apollo.io demo
- [ ] Request temporary API access or sandbox environment
- [ ] Document Apollo.io API endpoints: `/people/enrich`, `/people/search`, `/org/search`
- [ ] Test API with test_contacts.csv file
- [ ] Note: Apollo trial version doesn't support CSV enrichment
